epochedfiledir = 'C:\Users\jasminet\Desktop\TrustEEG\Epoched_advice';
...
epoch_info{1,1} = '71';
epoch_info{1,2} = '_advice_accurate_feedback';
epoch_info{2,1} = '72';
epoch_info{2,2} = '_advice_copycat_feedback';
epoch_info{3,1} = '73';
epoch_info{3,2} = '_advice_accurate_nofeedback';
epoch_info{4,1} = '74';
epoch_info{4,2} = '_advice_copycat_nofeedback';
